...
public class UserService {
	...
	public UserResponse updateUser(UUID id, UserUpdateRequest userUpdateRequest) {
	    ...
	    if (userUpdateRequest.getCourseId() != null) {
	        Course course = courseRepository.findById(userUpdateRequest.getCourseId())
	                .orElseThrow(() -> new EntityNotFoundException("Curso não encontrado com o ID: " + userUpdateRequest.getCourseId()));
	...
	public UserResponse createUser(UserRegisterRequest userRegisterRequest) {
		try {
			...
			if(userRegisterRequest.getCourseId() != null) {
				Course course = courseRepository.findById(userRegisterRequest.getCourseId())
			...
			if(userRegisterRequest.getDepartmentId() != null) {
				Department department = departmentRepository.findById(userRegisterRequest.getDepartmentId())
						.orElseThrow(() -> new EntityNotFoundException("Departamento não encontrado"));
